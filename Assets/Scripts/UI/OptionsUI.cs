...
public class OptionsUI : MonoBehaviour
{
    ...
    private float audioNormalizeMultiplier = 10f;
    ...
    {
        soundEffectsText.text = "Sound Effects: " + Mathf.Round(SoundManager.Instance.GetVolume() * audioNormalizeMultiplier);
        musicText.text = "Music: " + Mathf.Round(MusicManager.Instance.GetVolume() * audioNormalizeMultiplier);
